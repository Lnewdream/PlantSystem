...
const leafDb = [
    { id: 'L1', name: '小麦条锈病', type: '小麦', img: './images/wheat_stripe_rust.jpg' },
    ...
    { id: 'L8', name: '水稻稻曲病', type: '水稻', img: './images/rice_false_smut.jpg' },
    { id: 'L9', name: '玉米大斑病', type: '玉米', img: './images/corn_northern_blight.jpg' },
    { id: 'L10', name: '玉米小斑病', type: '玉米', img: './images/corn_southern_blight.jpg' },
    { id: 'L11', name: '玉米南方锈病', type: '玉米', img: './images/corn_southern_rust.jpg' },
    { id: 'L12', name: '番茄晚疫病', type: '番茄', img: './images/tomato_late_blight.jpg' },
    { id: 'L13', name: '番茄早疫病', type: '番茄', img: './images/tomato_early_blight.jpg' },
    { id: 'L14', name: '黄瓜霜霉病', type: '黄瓜', img: './images/cucumber_downy_mildew.jpg' },
    { id: 'L15', name: '葡萄霜霉病', type: '葡萄', img: './images/grape_downy_mildew.jpg' },
    { id: 'L16', name: '苹果轮纹病', type: '苹果', img: './images/apple_ring_rot.jpg' },
    { id: 'L17', name: '大豆锈病', type: '大豆', img: './images/soybean_rust.jpg' }
];
...
function renderGallery(type) {
    ...
    gallery.innerHTML = data.map(c => `
        <div class="crop-card group" style="aspect-ratio: 1 / 1;">
